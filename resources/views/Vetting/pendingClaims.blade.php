...
<script type="text/javascript">
    ...
    function loadClaims()
    {
            ...
            { 
                  ...
                  {
                    $('#tblClaims tbody').append('<tr><td>'+ value['Claim_ID'] +'</td><td>'+ value['Service_Provider'] +'</td><td><a href="/VetClaim/'+value['Claim_ID']+'"onclick="vetclaim(\''+value['Claim_ID']+'\')" class="btn btn-success pull-right">Vet Claim</a></td><td><a onclick="addtopool(\''+value['Claim_ID']+'\')" class="btn btn-success pull-right">Move to Pool</a></td></tr>');
