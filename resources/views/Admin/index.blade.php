...
<head>
    <head>
        ...
        <title>Phoenix Health Insurance - Claims Admin Portal</title>
        ...
        <div class="navbar navbar-fixed-top" >
            <div class="navbar-inner" style="background:black;">
                <div class="container" style="padding:10px;">
                    ...
                    Phoenix Health Claims Admin Portal | <?php echo date('d-m-Y'); ?>
                    </div>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="/AdminUsers"><i class="menu-icon icon-file"></i>Admin Users</a>
                                </li>
                                <li><a href="/SPManagement"><i class="menu-icon icon-tasks"></i>Service Provider Management<b class="label green pull-right">
